...
#bin
P="$D/bin"
tosync=("${tosync[@]}" "$HOME/bin/tablette@@@$P/tablette" "$HOME/bin/youtubedl@@@$P/youtubedl" "$HOME/bin/dockerClean@@@$P/dockerClean" "$HOME/bin/dockerStop@@@$P/dockerStop" "$HOME/bin/dockerRegistry@@@$P/dockerRegistry" "$HOME/bin/xt@@@$P/xt" )
